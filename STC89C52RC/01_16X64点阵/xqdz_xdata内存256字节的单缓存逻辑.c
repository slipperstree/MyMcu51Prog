...
void main()
{
	...
	// For test --------------------------------------------------------------------------------
	// setICDataToBuffer( getICData_Hanzi_16x16("全"), 32, 0);
	// setICDataToBuffer( getICData_Hanzi_16x16("场"), 32, 2);
	// setICDataToBuffer( getICData_Hanzi_16x16("两"), 32, 4);
	// setICDataToBuffer( getICData_Hanzi_16x16("折"), 32, 6);
	//setICDataToBuffer( getICData_Hanzi_16x16("语"), 32, 5);
	// readICDataToBuffer( showData);
...
void timer0() interrupt 1
{
	...
	if(tt >= 300){
		...
		if(nowOffset==15){
			...
			nowOffset=0;
			readICDataToBuffer(&showData[nowPos+=2]);
