...
// ******* 根据需要修改下列用于判断单击，双击有效的时间长短 ***********************************
    ...
    #define TICK_WAIT_CLICK_END         0x4000    //判断单击用，按下和弹起之间不能超过多久
    #define TICK_WAIT_DBCLICK_START     0x0050    //判断双击用，两次单击之间不能超过多久（如果判断成双击则单击无效）
    #define TICK_KEEPDOWN               0xA000    //判断按住不放用，按下以后需要持续多久
    #define TICK_KEEPDOWN_NEXT          0x1000    //按住不放的时候，每隔多久自动触发一次按住不放的事件
